...
async def visit(user_id, admin_token):
    url = f'https://sanitizer3000.dctf.si/profile/{user_id}'
    print("Visiting", url)
    ...
    browser.get("https://sanitizer3000.dctf.si/")
    browser.add_cookie({'name': 'admin_token', 'value': admin_token, 'url': 'https://sanitizer3000.dctf.si', 'httpOnly': False, 'sameSite': 'Strict', 'secure': False,'expiry': 9999999999})
